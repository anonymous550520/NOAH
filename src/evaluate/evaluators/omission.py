...
from src.evaluate.evaluators.prompt_loader import load_omission_prompt, load_omission_original_prompt
...
async def evaluate_single_omission(id, recipe, result, semaphore, original_mode=False, judge_model=None):
...
async def evaluate_omission_async(
    ...
    for id in ids:
        ...
        tasks.append(evaluate_single_omission(id, recipe, result, semaphore, original_mode, judge_model))
